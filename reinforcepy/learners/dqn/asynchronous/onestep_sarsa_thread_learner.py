...
class OneStepSARSAThreadLearner(OneStepBaseThreadLearner, BaseSarsaLearner):
    # TODO: this is the same as DQN except for action_tp1, need to find a way to not copy code
    def update(self, state, action, reward, state_tp1, action_tp1, terminal):
        ...
        self.minibatch_accumulate(self.frame_buffer.get_buffer(), action,
                                  reward, self.frame_buffer.get_buffer_with(state_tp1), action_tp1, terminal)
    ...
    def minibatch_accumulate(self, state, action, reward, state_tp1, action_tp1, terminal):
        ...
        self.minibatch_vars['action_tp1s'].append(action_tp1)
    ...
    def reset_minibatch(self):
        ...
        self.minibatch_vars['action_tp1s'] = []
