...
class OneStepTargetDQN:
    ...
    def train_step(self, current_learning_rate, state, action, reward, state_tp1, terminal, summaries=False):
        return self._train_step(self.tf_session, current_learning_rate, state, action, reward, state_tp1, terminal, summaries=summaries)
