...
class AsyncTargetCNN:
    def __init__(self, network_parms, training_parms):
        ...
        training_parms.required(['discount'])
        ...
        theano_updates = lasagne.updates.rmsprop(network_updates, params, learning_rate=learning_rate, rho=0.99, epsilon=0.1)
        ...
        self._gradient_step = theano.function([learning_rate], updates=theano_updates)
    ...
    def accumulate_gradients(self, state, action, reward, state_tp1, terminal):
        loss, grads = self.get_gradients(state, action, reward, state_tp1, terminal)
    ...
    def get_gradients(self, state, action, reward, state_tp1, terminal):
    ...
    def gradient_step(self, gradients, learning_rate: float):
        ...
        self._gradient_step(learning_rate)
